...
class SILab2Test {
    ...
    void everyBranchTest() {
        RuntimeException ex;
        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(-20,5,5)));
        assertTrue(ex.getMessage().contains("The hours are smaller than the minimum"));

        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(26,23,23)));
        assertTrue(ex.getMessage().contains("The hours are grater than the maximum"));

        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(20,-23,4)));
        assertTrue(ex.getMessage().contains("The minutes are not valid!"));

        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(18,23,-4)));
    ...
    void multipleCondition() {
        ...
        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(25,23,12)));
        assertTrue(ex.getMessage().contains("The hours are grater than the maximum"));

        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(2,-22,1)));
        assertTrue(ex.getMessage().contains("The minutes are not valid!"));

        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(12,68,12)));
        assertTrue(ex.getMessage().contains("The minutes are not valid!"));
        ...
        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(13,20,-1)));
        assertTrue(ex.getMessage().contains("The seconds are not valid"));

        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(15,20,79)));
        assertTrue(ex.getMessage().contains("The seconds are not valid"));
        ...
        ex = assertThrows(RuntimeException.class, () -> lab.function(createList(24,0,12)));
        assertTrue(ex.getMessage().contains("The time is greater than the maximum"));
